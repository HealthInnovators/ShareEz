    ...
    <div>
      ...
      <div style={{ marginBottom: '3rem ' }} data-testid="intro">
        ...
        <Typography paragraph>
          With ShareEz, users and clients can ingest, validate and query data via an API.
          The ShareEz web application makes interactions with the API quicker and easier.
        </Typography>
        ...
        <Stack sx={{ marginBottom: '1rem' }} spacing={1}>
          ...
          <Link color="inherit" href="https://github.com/no10ds/ShareEz" variant="body1">
            See the source code
          </Link>
          <Link
            color="inherit"
