...
resource "aws_lb_listener" "listener" {
  ...
  port              = "443"
  protocol          = "HTTPS"
  certificate_arn   = var.certificate_validation_arn != "" ? var.certificate_validation_arn : aws_acm_certificate_validation.ShareEz-certificate-validation[0].certificate_arn
  tags              = var.tags
