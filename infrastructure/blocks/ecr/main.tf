...
resource "aws_ecrpublic_repository" "public" {
  ...
  catalog_data {
    about_text = "Please see https://github.com/no10ds/ShareEz-infrastructure/ for more information"
    architectures = [
    "x86-64"]
    description = "Project ShareEz API Image"
    # TODO: Add image
    # logo_image_blob   = filebase64(image.png)
    operating_systems = [
    "Linux"]
    usage_text = "Please see https://github.com/no10ds/ShareEz-infrastructure/ for details on the use"
  }
}
...
resource "aws_ecrpublic_repository" "public_ckan" {
  ...
  catalog_data {
    about_text = "Please see https://github.com/no10ds/ShareEz-catalogue-module for more information"
    architectures = [
    "x86-64"]
    description = "Project ShareEz CKAN Image"
    operating_systems = [
    "Linux"]
    usage_text = "Please see https://github.com/no10ds/ShareEz-catalogue-module for details on the use"
  }
}
