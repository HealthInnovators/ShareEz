...
resource "aws_s3_bucket" "ShareEz_data_storage" {
...
resource "aws_s3_bucket_public_access_block" "ShareEz_data_storage" {
  bucket                  = aws_s3_bucket.ShareEz_data_storage.id
...
resource "aws_s3_bucket_notification" "ShareEz_data_storage" {
  bucket      = aws_s3_bucket.ShareEz_data_storage.id
  eventbridge = true
}
