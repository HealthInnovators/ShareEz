...
class Query(BaseModel):
    """
    A Query is a Pydantic class representing a ShareEz compatible data query. It allows for programmatic definition
    of data queries. See the ShareEz specific [documentation](</api/query>)
