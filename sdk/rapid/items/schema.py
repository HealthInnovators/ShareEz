...
class Schema(BaseModel):
    """
    A Schema is a Pydantic class representing a ShareEz schema. It allows you to programmatically define
    a schema to generate, create and update within ShareEz.
    ...
    def are_columns_the_same(
        ...
        Args:
            new_columns (Union[List[Column], List[dict]]): The new columns can be passed as either
                ...
                will raise a `ShareEz.exceptions.ColumnNotDifferentException`.
