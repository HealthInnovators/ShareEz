...
setup(
    ...
    description="A python sdk for the ShareEz API",
    url="https://github.com/no10ds/ShareEz/tree/main/sdk",  # Originally pointed to a deprecated repo, have updated
    author="Lewis Card",
    author_email="lcard@no10.gov.uk",
    license="MIT",
    packages=find_packages(include=["ShareEz", "ShareEz.*"], exclude=["tests"]),
