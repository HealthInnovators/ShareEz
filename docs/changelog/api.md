...
- Ability to pass a custom regex for username validation. See the documentation on the [`custom_user_name_regex`](https://ShareEz.readthedocs.io/en/latest/infrastructure/deployment/#usage) variable.
- Decoupled API & SDK into separate releases.
- New optional infrastructure variables to increase cpu and memory limits for the API container. See the [infrastructure variables for more information](https://ShareEz.readthedocs.io/en/latest/infrastructure/deployment/#usage).
...
- https://github.com/no10ds/ShareEz/issues/50
- https://github.com/no10ds/ShareEz/issues/59
- https://github.com/no10ds/ShareEz/issues/54
- https://github.com/no10ds/ShareEz/issues/51
...
- Added Athena workgroup and database as outputs of the ShareEz module.
