...
async def generate_schema(
    ...
    the [schema writing guide](https://ShareEz.readthedocs.io/en/latest/api/schema/) if you would like to create the schema yourself. You can then use the
    ...
    The set of values that can be specified for layer are specific to the instance of ShareEz. You can list them at the endpoint `/layers`.
...
async def upload_schema(schema: Schema):
    ...
    the [schema writing guide](https://ShareEz.readthedocs.io/en/latest/api/schema/)) or use the Schema Generation endpoint (see above).
