...
def retrieve_all_ShareEz_data_file_keys():
...
def retrieve_ShareEz_files_to_move_and_to_delete(loop_map_raw):
    to_delete = []
    to_move = []
...
ShareEz_data_files = retrieve_all_ShareEz_data_file_keys()
to_delete, to_move = retrieve_ShareEz_files_to_move_and_to_delete(ShareEz_data_files)
