"""
This script migrates all of your current ShareEz datasets to a given Layer, if none is given then it will just be the default layer.
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--all-layers",
        help="Specify all the layers that will exist on this ShareEz instance as strings separated by commas e.g 'raw,staging,presentation'. Defaults to 'default'",
    )
